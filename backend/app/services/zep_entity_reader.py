...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            func: The function to execute (lambda without parameters orcallable）
    ...
    def filter_defined_entities(
        ...
        Filter logic：
        - If the node has only one Labels"Entity"，Indicates that this entity does not conform to our predefined type, skip
        ...
        for node in all_nodes:
            ...
            # Filtering logic: Labels must contain"Entity"and"Node"tags outside
