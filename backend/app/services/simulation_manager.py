...
class SimulationState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Complete status dictionary (used internally）"""
        return {
    ...
    def to_simple_dict(self) -> Dict[str, Any]:
        """Simplified status dictionary (API returns using）"""
        return {
            "simulation_id": self.simulation_id,
            "project_id": self.project_id,
            "graph_id": self.graph_id,
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        try:
            ...
            # incominggraph_idto enable Zep retrieval for richer context
            ...
            profiles = generator.generate_profiles_from_entities(
                ...
                graph_id=state.graph_id,  # incominggraph_idUsed for Zep retrieval
            ...
            if progress_callback:
                progress_callback(
                    ...
                    f"Completed, total {len(profiles)} indivualProfile",
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                ...
                f"   - Run aloneTwitter: python {scripts_dir}/run_twitter_simulation.py --config {config_path}\n"
                f"   - Run aloneReddit: python {scripts_dir}/run_reddit_simulation.py --config {config_path}\n"
