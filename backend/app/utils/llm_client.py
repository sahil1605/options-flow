...
class LLMClient:
    ...
    def chat(
        ...
        # Some models (such asMiniMax M2.5）will be included in content<think>Thinking content needs to be removed
    ...
    def chat_json(
        ...
        try:
            ...
            raise ValueError(f"LLMThe returned JSON format is invalid: {cleaned_response}")
