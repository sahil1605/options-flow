        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast conversation version of Report Agent, can call 4 professional tools, and has MiroFish's complete memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Align real-world seed data with simulation environment status, combining Global/Local Memory mechanisms to provide cross-temporal deep attribution analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph structure-based breadth traversal algorithm, reconstruct event propagation paths, capture the topological structure of all information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface, optimize indexing efficiency, used to quickly extract specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview, can perform multi-round dialogues with individuals in the simulation world in parallel, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent for deeper understanding' : 'Chat with simulated individuals to understand their perspectives' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Select Survey Target</span>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Choose someone to talk to: ${agent.username}`)
}
...
const sendMessage = async () => {
  ...
  try {
    ...
    addLog(`Sending failed: ${err.message}`)
    chatHistory.value.push({
      role: 'assistant',
...
const sendToAgent = async (message) => {
  ...
  addLog(`Towards ${selectedAgent.value.username} send: ${message.substring(0, 50)}...`)
...
const submitSurvey = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`receive ${surveyResults.value.length} Replies`)
    } else {
      throw new Error(res.error || 'Request failed')
    }
  } catch (err) {
...
const loadProfiles = async () => {
  ...
  try {
    ...
    addLog(`Failed to load simulated entity: ${err.message}`)
  }
}
