        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3「"Start Simulation" and Step 5 "Deep Interaction" need to be started during operation, and historical playback is not supported.</span>
            </div>
          </div>
        </div>
      </Transition>
...
const selectedProject = ref(null)  // The currently selected item (for pop-up windows）
let observer = null
...
// Card layout configuration - Adjust to wider proportions
...
// Formatted round number display (current round/Total rounds）
  ...
  observer = new IntersectionObserver(
    (entries) => {
      entries.forEach((entry) => {
        ...
        // Update the target state to be executed (the latest target state must be recorded regardless of whether it is in animation or not)）
