      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          ...
          <div class="header-right">
            ...
            <div class="action-buttons">
                <button class="action-btn" @click="refreshGraph" :disabled="graphLoading" title="Refresh map">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="graphLoading" class="graph-loading">
            ...
            <p class="loading-text">Spectrum data loading...</p>
          </div>
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-text">Waiting for the ontology to be generated</p>
            <p class="waiting-hint">After the generation is completed, it will automatically start to build the map.</p>
          </div>
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-text">Map under construction</p>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading the document, LLM analyzes the document content and automatically generates an ontology structure (entity type) suitable for public opinion simulation. + Relationship type）
                </div>
              </div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">Generated entity type ({{ projectData.ontology.entity_types?.length || 0 }})</div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">Generated relationship type ({{ projectData.ontology.relation_types?.length || 0 }})</div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              ...
              <div class="detail-section waiting-state" v-if="currentPhase < 1">
                <div class="waiting-hint">Wait for the ontology generation to be completed...</div>
              </div>
        ...
        <div class="project-panel">
          ...
          <div class="project-details" v-if="projectData">
            ...
            <div class="project-item" v-if="projectData.graph_id">
              <span class="item-label">AtlasID</span>
...
// Current project ID (possibly from'new'become realityID）
...
const statusText = computed(() => {
  ...
  if (currentPhase.value === 1) return 'Map under construction'
  if (currentPhase.value === 0) return 'Ontology is being generated'
  return 'Initializing'
})
...
const goToNextStep = () => {
  ...
  alert('The environment building function is under development...')
}
...
const startBuildGraph = async () => {
  try {
    ...
    if (response.success) {
      buildProgress.value.message = 'The graph construction task has been started...'
  ...
  try {
    ...
    if (response.success) {
      ...
      if (task.status === 'completed') {
        console.log('✅ The graph construction is completed and the complete data is being loaded....')
        ...
        buildProgress.value = {
          progress: 100,
          message: 'The construction is completed and the map is loading....'
        }
        ...
        if (projectResponse.success) {
          ...
          if (projectResponse.data.graph_id) {
            console.log('📊 Load complete map:', projectResponse.data.graph_id)
