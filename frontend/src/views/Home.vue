      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <h1 class="main-title">
            ...
            <span class="gradient-text">Instantly rehearse the future</span>
          </h1>
          
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world consisting of up to <span class="highlight-orange">million-level Agents</span> based on real-world seeds. Inject variables from a God's-eye view to find <span class="highlight-code">"local optimal solutions"</span> in complex social interactions.
            </p>
            <p class="slogan-text">
              Rehearse the future within Agent groups, and win decisions after countless simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload multiple unstructured data sources to initialize the simulation sequence.
          </p>
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Up to million-level Agents</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relationship extraction & Persona generation & Simulation parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements (e.g. What would happen if the university retracts the penalty as requested?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - redirect immediately, API call in Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Redirect to Process page (using special ID for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as primary title font, JetBrains Mono for code/labels
